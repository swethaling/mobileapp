...
public class ProductActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productImageView.setImageResource(R.drawable.slide3);
        productNameTextView.setText("SHOTGUN");
        productPriceTextView.setText("₹ 5,495.00");
        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ProductActivity3.this, "Product added to cart", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        payButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ProductActivity3.this, "Order placed", Toast.LENGTH_SHORT).show();
                sendNotification();
            }
        });
