...
public class ProductActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productImageView.setImageResource(R.drawable.cycle2);
        productNameTextView.setText("BLUNT");
        productPriceTextView.setText("₹ 16,000.00");
        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ProductActivity4.this, "Product added to cart", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        payButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ProductActivity4.this, "Order placed", Toast.LENGTH_SHORT).show();
                sendNotification();
            }
        });
